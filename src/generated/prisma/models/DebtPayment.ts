...
export type DebtPaymentWhereInput = {
  ...
  debtPaymentId?: Prisma.IntFilter<"DebtPayment"> | number
...
export type DebtPaymentOrderByWithRelationInput = {
  debtPaymentId?: Prisma.SortOrder
...
export type DebtPaymentScalarWhereWithAggregatesInput = {
  ...
  debtPaymentId?: Prisma.IntWithAggregatesFilter<"DebtPayment"> | number
...
export type $DebtPaymentPayload<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  name: "DebtPayment"
  objects: {
    debt: Prisma.$DebtsPayload<ExtArgs>
  }
...
export interface DebtPaymentDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `debtPaymentId`
   * const debtPaymentWithDebtPaymentIdOnly = await prisma.debtPayment.findMany({ select: { debtPaymentId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many DebtPayments and only return the `debtPaymentId`
   * const debtPaymentWithDebtPaymentIdOnly = await prisma.debtPayment.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more DebtPayments and only return the `debtPaymentId`
   * const debtPaymentWithDebtPaymentIdOnly = await prisma.debtPayment.updateManyAndReturn({
   *   select: { debtPaymentId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface Prisma__DebtPaymentClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
  ...
  debt<T extends Prisma.DebtsDefaultArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.DebtsDefaultArgs<ExtArgs>>): Prisma.Prisma__DebtsClient<runtime.Types.Result.GetResult<Prisma.$DebtsPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | Null, Null, ExtArgs, GlobalOmitOptions>
  /**
...
export interface DebtPaymentFieldRefs {
  readonly debtPaymentId: Prisma.FieldRef<"DebtPayment", 'Int'>
